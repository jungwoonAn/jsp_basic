...
<body>
    <h3>변수 선언 및 할당</h3> 
    스크립틀릿에서 선언한 변수 : ${ num1 } <br><!-- 스크립트릿에서 선언한 변수 즉시 사용 불가 -->
    page 영역에 저장된 변수 : ${ num2 } <br>
    변수 할당 및 즉시 출력 : ${ num1 = 7 } <br>
    변수 할당 및 별도 출력 : ${ num2 = 8;'' } => ${ num2 } <br><!-- num2는 할당O, 출력X -->
    ...
    <h3>+ 연산자는 덧셈만 가능</h3>  
    num1 + "34" : ${ num1 + "34" } <br> 
    num2 + "이십" : \${num2 + "이십" }<!-- 에러 발생(+연산자 문자열 연결에 사용 불가) --> <br>
    "삼십" + "사십" : \${"삼십" + "사십" }<!-- 에러 발생(+연산자 문자열 연결에 사용 불가) -->
